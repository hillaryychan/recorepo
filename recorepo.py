...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--public', action='store_true',
                        help='Make the repository public. Private by default')
    parser.add_argument('-i', '--init', action='store_true',
                        help='Initialise repository upon creation')
    parser.add_argument('--https', action='store_true',
                        help='Redirect repository to have HTTPS origin path. Uses SSH by default')
